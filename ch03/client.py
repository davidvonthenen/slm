...
"""OpenAI-compatible client for a local or hosted language model endpoint."""
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Query an OpenAI-compatible language model endpoint.")
    parser.add_argument("--question", required=True, help="Question to ask the language model.")
